...
export function Scene7Contact() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center px-4 md:px-8" style={{ paddingTop: '5rem', paddingBottom: '5rem' }}>
      ...
      >
        ...
        >
          ...
          <div style={{ padding: 'clamp(2.5rem, 5vw, 4rem)' }}>
            ...
            {/* Contact Information */}
            <div className="border-t" style={{ marginTop: 'clamp(2.5rem, 5vw, 3.5rem)', paddingTop: 'clamp(1.5rem, 3vw, 2.5rem)', borderColor: 'rgba(77, 124, 254, 0.2)' }}>
              <p
              ...
              <div className="flex items-center justify-center gap-8">
                ...
                >
                  <motion.div
                    ...
                    transition={{ duration: 0.2 }}
                    className="w-12 h-12 flex items-center justify-center border-2 border-[#4D7CFE]/30 bg-black/40 hover:border-[#4D7CFE] hover:bg-[#4D7CFE]/10 transition-all duration-300"
                    style={{ boxShadow: '0 0 20px rgba(77, 124, 254, 0.1)' }}
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" style={{ color: '#4D7CFE' }}>
